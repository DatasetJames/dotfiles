...
# if proxy
sudo gem install --http-proxy http://user:pass@proxy.*****:8180 github-pages rake pygments.rb jekyll html-proofer jemoji jekyll-mentions jekyll-seo-tag jekyll-feed jekyll-sitemap jekyll-gist --no-rdoc --no-ri
